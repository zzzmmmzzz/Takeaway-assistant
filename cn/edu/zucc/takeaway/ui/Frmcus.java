...
public class Frmcus extends JDialog implements ActionListener {
	...
	private JLabel labelUser = new JLabel("ÓÃ»§ÕËºÅ£º");
	private JLabel labelPwd = new JLabel("ÃÜÂë£º");
	private JTextField edtUserId = new JTextField(20);
	private JPasswordField edtPwd = new JPasswordField(20);

	public Frmcus(Dialog f, String s, boolean b) {
		super(f, s, b);
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == this.btnLogin) {
			...
			try {
				Beancus.currentloginUser= takeawayUtil.customerManager.login(userid, pwd);
