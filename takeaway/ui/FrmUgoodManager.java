...
public class FrmUgoodManager extends JFrame implements ActionListener {
	private JMenuBar menubar=new JMenuBar();
	
	private JMenu menu_goodManager=new JMenu("商品管理");
	private JMenu menu_goodcategoriesManager=new JMenu("商品类别管理");
	...
	public FrmUgoodManager(){
		...
		this.dataTablePlan.addMouseListener(new MouseAdapter (){
			...
			public void mouseClicked(MouseEvent e) {
				...
				FrmUgoodManager.this.reloadgoods_categories(i);
			}
		...
		this.dataTablegoodscategories.addMouseListener(new MouseAdapter (){
			...
			@Override
			public void mouseClicked(MouseEvent e) {
				int i=FrmUgoodManager.this.dataTablegoodscategories.getSelectedRow();
				if(i<0) {
					return;
				}
